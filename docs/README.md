# VeilCheck documentation

VeilCheck is a proposal-stage open-source project. This documentation is intentionally specific about current behavior, planned behavior, and unresolved decisions.

| Read this | When you need to know |
| --- | --- |
| [Project charter](project-charter.md) | Why VeilCheck exists, who it serves, and what success looks like |
...
| [Policy specification](policy-spec.md) | How to write `veilcheck/v1` policy documents |
...
| [Pilot guide](pilot-guide.md) | How a design partner evaluates VeilCheck without exposing sensitive code/data |
| [Competitive landscape](competitive-landscape.md) | What exists, what VeilCheck adds, and claims to avoid |
| [Risk register](risk-register.md) | Product, technical, legal, and ecosystem risks with mitigations |
| [Security architecture](security-architecture.md) | How VeilCheck protects repositories, reports, and CI |
